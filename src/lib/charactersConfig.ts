...
export const CHARACTERS_ROSTER: CharacterConfig[] = [
  ...
  // ==========================================
  {
    ...
    perks: [
      ...
      { icon: "coin", text: "+5 Gold per task reward" },
  ...
  },
  {
    ...
    perks: [
      ...
      { icon: "coin", text: "Bonus 15 gold on deep work completion" },
    ],
    meshType: "scholar",
  ...
  },
  {
    ...
    perks: [
      ...
      { icon: "coin", text: "+20 Gold per physical bounty quest" },
    ],
    meshType: "vanguard",
  ...
  },
  {
    ...
    perks: [
      { icon: "flame", text: "+50% Extra gold on Hard & Heroic quests" },
  ...
  },
  {
    ...
    perks: [
      { icon: "star", text: "+50% All XP and Gold quest gains permanently" },
  ...
  },
  {
    ...
    perks: [
      ...
      { icon: "coin", text: "+20 Gold on study & reading sessions" },
    ],
    meshType: "sorceress",
  ...
  },
  {
    ...
    perks: [
      ...
      { icon: "flame", text: "Dual Plasma Dagger strikes deal bonus gold" },
